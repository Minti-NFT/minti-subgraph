...
export class SingleAsset extends SmartContract {
  static bind(address: Address): SingleAsset {
    return new SingleAsset("SingleAsset", address);
  }
  ...
  mint(recipient: Address, uri: string): BigInt {
  ...
  try_mint(recipient: Address, uri: string): CallResult<BigInt> {
